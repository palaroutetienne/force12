function matriceEncyclopedie(rangRecup,r,r2,zoneDessin,ladiv,tabToutesLesMatrices)
{
    ...
    for (var j=0;j<12;j++)
    {
        ...
        point[j].on(
            "click",function()
            {
                surClicPointEncy(this,calqueNoteEtCercle,canvas,r,r2,zoneDessin,ladiv,tabToutesLesMatrices);
            });
    ...
    var g = afficherMatriceEncyclopedie(calqueNoteEtCercle,point,rangRecup,r,zoneDessin,ladiv,tabToutesLesMatrices);
    
    //Récup le rang de la matrice genre 001 et pas 001_1
    ...
    document.getElementById("nomenclature").innerHTML = "<p>"+tabToutesLesMatrices[g].nomenclature+"</p><p class=texte-gris>"+tabToutesLesMatrices[g].origine+"</p>";
}//Fin fonction